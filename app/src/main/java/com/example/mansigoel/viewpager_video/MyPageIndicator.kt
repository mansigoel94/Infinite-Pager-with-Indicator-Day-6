...
class MyPageIndicator(private val mContext: Context, private val mContainer: LinearLayout?, private val mViewPager: ViewPager, @param:DrawableRes private var mDrawable: Int) : ViewPager.OnPageChangeListener {
